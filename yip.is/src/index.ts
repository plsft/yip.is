						...
						<div class="bg-white dark:bg-gray-900 rounded-2xl shadow-xl border border-gray-200 dark:border-gray-800 p-8 relative animate-slide-in" id="ip-card">
							...
							<div class="flex justify-between items-center pt-4">
								...
								<div class="flex gap-2">
									<a href="https://github.com/plsft/yip.is" target="_blank" aria-label="GitHub" class="p-3 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors group">
